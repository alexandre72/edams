...
extern pid_t xPLPID;
extern Eina_Bool xPL_DebugMode;
...
/* xPL-service.c */
extern Eina_Bool xPL_sendHeartbeat(xPL_ServicePtr);
...
/* xPL-listeners.c */
extern Eina_Bool xPL_dispatchRawEvent(String, int);
extern Eina_Bool xPL_dispatchMessageEvent(xPL_MessagePtr);
extern Eina_Bool xPL_dispatchServiceEvent(xPL_ServicePtr, xPL_MessagePtr);
extern Eina_Bool xPL_dispatchServiceConfigChangedEvent(xPL_ServicePtr);

/* xPL-io.c */
extern Eina_Bool xPL_sendRawMessage(String, int);
