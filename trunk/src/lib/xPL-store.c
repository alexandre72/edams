 ...
 */
static void
releaseItem(cachedItem theItem, itemCachePtr theCache)
{
 ...
 */
static cachedItem
allocItem(itemCachePtr theCache)
{
 ...
 */
void
xPL_FreeNVList(xPL_NameValueListPtr theList)
{
  CONFIRM_CACHE_OK;
 ...
 */
void
xPL_FreeMessage(xPL_MessagePtr theMessage)
{
  CONFIRM_CACHE_OK;
 ...
 */
void
xPL_FreeService(xPL_ServicePtr theService)
{
  CONFIRM_CACHE_OK;
...
String
xPL_StrNDup(String theOrigString, int maxChars)
{
  String theString;
  int theLength;
