...
struct _Widget
{
    ...
    Eina_Stringshare *device_id;	 	/*Id of device 'ATM8xxTX'. Should be unique*/
    Eina_Stringshare *device_type;	 	/*Type of device e.g. 'TEMP_SENSOR_BASIC_TYPE'*/
    Eina_Stringshare *device_current;	/*Current data of device*/
    Eina_Stringshare *device_highest;	/*Highest recorded value*/
    Eina_Stringshare *device_lowest;	/*Lowest recorded value*/
...
_widget_init(void)
{
    ...
    EET_DATA_DESCRIPTOR_ADD_BASIC(_widget_descriptor, Widget, "device_id", device_id, EET_T_STRING);
    EET_DATA_DESCRIPTOR_ADD_BASIC(_widget_descriptor, Widget, "device_type", device_type, EET_T_STRING);
    EET_DATA_DESCRIPTOR_ADD_BASIC(_widget_descriptor, Widget, "device_current", device_current, EET_T_STRING);
    EET_DATA_DESCRIPTOR_ADD_BASIC(_widget_descriptor, Widget, "device_highest", device_highest, EET_T_STRING);
    EET_DATA_DESCRIPTOR_ADD_BASIC(_widget_descriptor, Widget, "device_lowest", device_lowest, EET_T_STRING);
...
widget_new(const char * name, Widget_Class class)
{
	...
	if(class == WIDGET_CLASS_CONTROL)
		widget->group = eina_stringshare_add("widget/control/switch");
   	 	...
   	 	widget->group = eina_stringshare_add("widget/sensor/counter");
    else
        debug(MSG_ERROR, _("You shouldn't create a new widget with unknown class"));

    /*Initialize device specifics field*/
    widget->device_id = NULL;
    widget->device_type = NULL;
    widget->device_current = NULL;
    widget->device_highest = NULL;
    widget->device_lowest = NULL;
...
widget_free(Widget *widget)
{
       ...
       (widget->class == WIDGET_CLASS_SENSOR ))
    {
        ...
        eina_stringshare_del(widget->device_type);        
        eina_stringshare_del(widget->device_current);
        eina_stringshare_del(widget->device_highest);
        eina_stringshare_del(widget->device_lowest);
    }
...
widget_clone(Widget *src)
{
    ...
    if((src->class == WIDGET_CLASS_CONTROL) ||
...
{
    return elm_entry_markup_to_utf8(widget->name);
}/*widget_name_get*/
 ...
 */
inline void
widget_device_id_set(Widget *widget, const char *id)
{
    EINA_SAFETY_ON_NULL_RETURN(widget);
    if((widget->class == WIDGET_CLASS_CONTROL) ||
       (widget->class == WIDGET_CLASS_SENSOR))
...
widget_device_id_get(const Widget *widget)
{
    ...
    return NULL;
}/*widget_device_id_get*/

/*
 *
 */
inline void
widget_device_type_set(Widget *widget, const char *type)
{
    EINA_SAFETY_ON_NULL_RETURN(widget);
    ...
    if((widget->class == WIDGET_CLASS_CONTROL) ||
       (widget->class == WIDGET_CLASS_SENSOR))
    {
    	eina_stringshare_replace(&(widget->device_type), type);
    }
}/*widget_device_type_set*/

/*
 *
 */
inline const char*
widget_device_type_get(const Widget *widget)
{
    if((widget->class == WIDGET_CLASS_CONTROL) ||
       (widget->class == WIDGET_CLASS_SENSOR))
    {
        return widget->device_type;
    }
    return NULL;
}/*widget_device_type_get*/

/*
 *
 */
inline void
widget_device_current_set(Widget *widget, const char *current)
{
    EINA_SAFETY_ON_NULL_RETURN(widget);
    if((widget->class == WIDGET_CLASS_CONTROL) ||
       (widget->class == WIDGET_CLASS_SENSOR))
    {
    	eina_stringshare_replace(&(widget->device_current), current);
    }
}/*widget_device_current_set*/

/*
 *
 */
inline const char *
widget_device_current_get(const Widget *widget)
{
    if((widget->class == WIDGET_CLASS_CONTROL) ||
       (widget->class == WIDGET_CLASS_SENSOR))
    {
        return widget->device_current;
    }

    return NULL;
}/*widget_device_current_get*/
 ...
 */
inline void
widget_device_highest_set(Widget *widget, const char *highest)
{
    EINA_SAFETY_ON_NULL_RETURN(widget);
    if((widget->class == WIDGET_CLASS_CONTROL) ||
       (widget->class == WIDGET_CLASS_SENSOR))
    {
    	eina_stringshare_replace(&(widget->device_highest), highest);
    }
}/*widget_device_highest_set*/
 ...
 */
inline const char *
widget_device_highest_get(const Widget *widget)
{
    if((widget->class == WIDGET_CLASS_CONTROL) ||
       (widget->class == WIDGET_CLASS_SENSOR))
    {
        return widget->device_highest;
    }

    return NULL;
}/*widget_device_highest_get*/
 ...
 */
inline void
widget_device_lowest_set(Widget *widget, const char *lowest)
{
    EINA_SAFETY_ON_NULL_RETURN(widget);
    if((widget->class == WIDGET_CLASS_CONTROL) ||
       (widget->class == WIDGET_CLASS_SENSOR))
    {
    	eina_stringshare_replace(&(widget->device_lowest), lowest);
    }
}/*widget_device_lowest_set*/
 ...
 */
inline const char *
widget_device_lowest_get(const Widget *widget)
{
    if((widget->class == WIDGET_CLASS_CONTROL) ||
       (widget->class == WIDGET_CLASS_SENSOR))
    {
        return widget->device_lowest;
    }

    return NULL;
}/*widget_device_lowest_get*/
