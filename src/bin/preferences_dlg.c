...
static void
apply_bt_clicked_cb(void *data __UNUSED__, Evas_Object *obj __UNUSED__, void *event_info __UNUSED__)
{
...
static void
_options_list_selected_cb(void *data __UNUSED__, Evas_Object *obj __UNUSED__, void *event_info)
{
    Eina_List *its, *l;
    Elm_Object_Item *it;
